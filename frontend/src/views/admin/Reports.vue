<template>
    ...
    <div v-else class="flex max-w-screen md:min-h-full flex-col gap-3">
        ...
        <!-- First Row -->
        <div
            class="flex items-center justify-center flex-col sm:flex-row gap-2"
        >
            <Card class="h-full"
                ><Bar
            ...
            <Card
                ><Line :data="totalOrders" :height="350" :width="250" />
            </Card>
        </div>
    </div>
</template>
