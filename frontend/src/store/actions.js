...
const actions = {
    ...
    updateUser({ commit }, user) {
        ...
        return axios
            .post(`/admin/put/user/${user.id}`, form)
            .then((response) => {
                return response;
            });
    },
    updateProduct({ commit }, product) {
        ...
        return axios
            .post(`/admin/put/product/${product.id}`, form)
            .then((response) => {
                return response;
            });
    },
    ...
    updateCategory({ commit }, category) {
        return axios
            .post(`/admin/put/category/${category.id}`, category)
            .then((response) => {
                return response;
            });
    },
    ...
    removeProduct({ commit }, id) {
        return axios.post(`/admin/delete/product/${id}`).then((response) => {
            return response;
        });
    },
    removeCategory({ commit }, id) {
        return axios.post(`/admin/delete/category/${id}`).then((response) => {
            return response;
        });
    },
    removeUser({ commit }, id) {
        return axios.post(`/admin/delete/user/${id}`).then((response) => {
            return response;
        });
    },
    ...
    async updateCart({ commit, getters, dispatch }, { product_id, quantity }) {
        ...
        if (newQuantity <= 0) {
            ...
            return axios
                .post(`/put/cart`, { product_id, quantity: newQuantity })
                .then((response) => {
