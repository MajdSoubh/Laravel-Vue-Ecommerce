<template>
    <div class="flex max-w-screen md:min-h-full flex-col gap-3">
        <div class="flex justify-between items-center h-[7%]">
            <h2 class="text-2xl font">Dashboard</h2>
            <div class="flex gap-2 items-center">
                <label class="hidden sm:block" for="period"
                    >Change Date Period</label
                >
                <select
                    v-model="period"
                    @change="getData"
        ...
        <!-- First Row -->
        <div class="flex flex-col sm:flex-row gap-3 h-[21%]">
            <Card
                ><div
        ...
        <!-- Second Row -->
        <div class="flex flex-col sm:flex-row gap-3 min-h-[71%]">
            <Card
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <p class="inline-block">
                                        Created at {{ order.created_at }}.<span>
                                            items
                                        </span>
                                        {{ order.items_count }}
                                    </p>
            ...
            <div class="flex flex-col gap-3">
                <Card class="grow"
                    ><div
                        class="flex flex-col gap-2 items-center justify-center grow"
                    >
                        ...
                        <Pie
                            ...
                            :width="200"
                            :height="200"
                            class="text-center max-w-[200px] max-h-[200px]"
                ...
                <Card class="grow"
                    ...
                    >
                        <p class="text-xl font-medium">Latest Customer</p>
                        <div
                        ...
                        >
                            ...
                            <div
                                ...
                                :key="ind"
                                class="w-full p-2 rounded-md flex gap-2 items-center cursor-pointer hover:bg-blue-100"
                            >
                                <!-- Avatar -->
                                <div>
                                    <svg
